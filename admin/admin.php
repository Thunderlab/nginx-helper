...
namespace rtCamp\WP\Nginx {
    ...
    class Admin {
         ...
         */
        function add_menu() {
            add_submenu_page( 'options-general.php', __( 'Cache', 'nginx-helper' ), __( 'Cache', 'nginx-helper' ), 'manage_options', 'nginx', array( &$this, 'nginx_create_admin_page' ) );
        }
        ...
        function add_network_menu() {
            add_submenu_page( 'settings.php', __( 'Cache', 'nginx-helper' ), __( 'Cache', 'nginx-helper' ), 'manage_options', 'nginx', array( &$this, 'nginx_create_admin_page' ) );
        }
